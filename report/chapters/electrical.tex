...
\begin{enumerate}
	\item \ssp Mounted IMU on fully assembled robot and connect to the microcontroller.
...
\end{figure}
Since the measurements primarily appear to possess linear error, only a linear correction is required as in Equation \ref{eq:rf_cal}:
\begin{equation}
\label{eq:rf_cal}
