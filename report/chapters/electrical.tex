...
\node [int](battery){LiPo Battery};
\node[int, right of = battery,minimum size=2cm,text height=2em, align=center](ldo5v){5V LDO\\ AZ1085CD};
\node[int, right of = battery, below of=ldo5v](ldo3v3){3V3 LDO\\ AZ1085CD};
\path[->] (battery) edge node {} (ldo5v);
\path[->] (battery) edge node {} (ldo3v3);

\end{tikzpicture}

\begin{tikzpicture}[node distance=2.5cm,auto,>=latex']
\node [int, pin={[init]above:$v_0$}] (a) {$\frac{1}{s}$};
\node [left of=a,node distance=2cm, coordinate] (b) {};
